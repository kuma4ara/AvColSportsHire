...
namespace AvColSportsHire.Controllers
{
    public class BookEquipmentsController : Controller
    {
        ...
        {
            ViewData["BookingId"] = new SelectList(_context.Set<Booking>(), "BookingId", "BookingReference");
            ViewData["EquipmentId"] = new SelectList(_context.Set<Equipment>(), "EquipmentId", "Name");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("BookEquipId,BookingId,EquipmentId,QuantityBooked")] BookEquipment bookEquipment)
        {
            ...
            ViewData["BookingId"] = new SelectList(_context.Set<Booking>(), "BookingId", "BookingReference", bookEquipment.BookingId);
            ViewData["EquipmentId"] = new SelectList(_context.Set<Equipment>(), "EquipmentId", "Name", bookEquipment.EquipmentId);
            return View(bookEquipment);
        }
