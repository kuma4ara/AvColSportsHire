...
namespace AvColSportsHire.Controllers
{
    public class BookingsController : Controller
    {
        ...
        {
            var sportsHireContext = _context.Booking.Include(b => b.Location);
        ...
        {
            ViewData["LocationId"] = new SelectList(_context.Set<Location>(), "LocationId", "Description");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("BookingId,BookingReference,StartDateTime,EndDateTime,OtherEventTypeDescription,CustomerId,StaffId,LocationId,CreatedAt,TotalParticiants,Amount")] Booking booking)
        {
            ...
            ViewData["LocationId"] = new SelectList(_context.Set<Location>(), "LocationId", "Description", booking.LocationId);
            return View(booking);
        }
