...
namespace AvColSportsHire.Controllers
{
    public class OrganizationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OrganizationId,Name,Contact_Email,Contact_Phone,PasswordHash,IsInternal,IsActive")] Organization organization)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int? id, [Bind("OrganizationId,Name,Contact_Email,Contact_Phone,PasswordHash,IsInternal,IsActive")] Organization organization)
        {
