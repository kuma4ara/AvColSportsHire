...
{
    /// <inheritdoc />
    public partial class InitialCreateNewModels : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FacilitiesFacilityId = table.Column<int>(type: "int", nullable: true),
                    SportsHireUserId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Bookings", x => x.BookingId);
                    table.ForeignKey(
                        name: "FK_Bookings_AspNetUsers_SportsHireUserId",
                        column: x => x.SportsHireUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Bookings_Facilities_FacilitiesFacilityId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_FacilitiesFacilityId",
                table: "Bookings",
                column: "FacilitiesFacilityId");

            migrationBuilder.CreateIndex(
                name: "IX_Bookings_SportsHireUserId",
                table: "Bookings",
                column: "SportsHireUserId");
        }
